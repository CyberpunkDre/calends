...
static void example_app_open (GApplication  *app, GFile **files,
...
ExampleApp * example_app_new (void){
  return g_object_new (EXAMPLE_APP_TYPE, "application-id", "com.github.cyberpunkdre.calends",
